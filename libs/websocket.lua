-- Originally from: https://github.com/flaribbit/love2d-lua-websocket
-- Licensed under the MIT License. See third_party_licenses/love2d-lua-websocket-LICENSE.txt
...
-- Parses a URL like ws://localhost:8000/path into host, port, and path
...
function _M.new(host_or_url, port, path)
    local host
    if port == nil and path == nil then
        -- Assume it's a full URL
        host, port, path = parse_url(host_or_url)
    else
